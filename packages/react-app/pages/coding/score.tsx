...
export default function Score() {
    ...
    return <main className="flex justify-center items-center my-10">
        <div
            ...
            <img
                ...
                src="https://static.vecteezy.com/system/resources/previews/022/817/646/original/graduation-cartoon-character-illustration-png.png"
                alt="" />
